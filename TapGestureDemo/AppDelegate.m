...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(stateChange:) name:NSSystemTimeZoneDidChangeNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(userChangeTime) name:NSSystemClockDidChangeNotification object:nil];
    return YES;
}

- (void)userChangeTime{
    NSLog(@"userChangeTime");
}

- (void)stateChange:(id)userinfo{
    NSLog(@"stateChange userinfo:%@",userinfo);
}
